...
function getPointGen() {
	...
	let gain = new Decimal(1).mul(player.a.points.add(1)).mul(player.b.points.add(1)).mul(player.c.points.add(1)).mul(player.d.points.add(1)).mul(player.e.points.add(1)).mul(player.f.points.add(1)).mul(player.g.points.add(1)).mul(player.h.points.add(1)).mul(player.i.points.add(1)).mul(player.j.points.add(1)).mul(player.k.points.add(1)).mul(player.l.points.add(1)).mul(player.m.points.add(1)).mul(player.n.points.add(1)).mul(player.n.points.add(1)).mul(player.o.points.add(1)).mul(player.p.points.add(1)).mul(player.q.points.add(1)).mul(player.r.points.add(1)).mul(player.s.points.add(1)).mul(player.t.points.add(1)).mul(player.u.points.add(1)).mul(player.v.points.add(1)).mul(player.w.points.add(1)).mul(player.x.points.add(1)).mul(player.y.points.add(1)).mul(player.z.points.add(1)).mul(player.a2.points.add(1))
	return gain
}
